...
The figure below compares predictions generated by the CNN, VGG16, AlexNet, InceptionV3 (GoogLeNet), and DenseNet201 models on a common set of test images. The comparison highlights differences in classification performance across architectures and demonstrates the effectiveness of transfer learning for dog weight classification.

<p align="center">
  <img src="images/results/model_prediction_comparison.png" width="900">
</p>

<p align="center">
  <em>Figure 1. Comparison of CNN and Transfer Learning Model Predictions on Test Images.</em>
</p>
